  ...
  return (
    <>
      <Head>
        ...
        <meta prefix="og: http://ogp.me/ns/article#" property="article:modified_time"  content={dateModified} />
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="./static/touch/touch-icon-iphone-retina.png" />
        <link rel="apple-touch-icon" sizes="167x167" href="./static/touch/touch-icon-ipad-retina.png" />
      </Head>
