      ...
      <Row>
        ...
        >
          ...
          <p>
            ...
            advertisements, nor serve any trackers for any advertisement purpose. We do not store
            any personal information on any internal databases. As much as possible, we will respect
            and respond to your privacy requests.
          </p>
          <h2>Summary</h2>
          <p>
            ...
            place you can possibly volunteer any personal information is our form to subscribe to
            our email list, administered through Mailchimp. You can read their data retention policy{' '}
            ...
            <br />
            <br />
            Ballot.fyi is a statically-generated site. With the exception of serving
            browser-specified prefences such as preferred language and font size, our service is
            largely the same across users.
          </p>
          ...
          <p>
            ...
            entity Amir & Erica, Inc. (DBA By The Bay), and funded by a grant from the{' '}
          ...
          <p>
            ...
            ballot.fyi does not affiliate with Wikipedia or allaboutdnt.com, nor do we guarantee
          ...
          <p>
            ...
            third-party entities that can receive usage data about you from www.ballot.fyi. Below,
            we also describe some of the data these services collect from our shared users that are
            available to us. For full descriptions of the data each service provides to its
            customers, such as ballot.fyi, we encourage you to read their privacy policies or terms
            of services.
          </p>
          ...
          <p>
            ...
            That is a subset of what is tracked. Ballot.fyi will use this information for
            analytical, internal purposes, only. For more information:{' '}
            <LinkOut href="https://policies.google.com/privacy">
          ...
          <p>
            ...
            For those who are curious as to why there are two analytics providers, here&apos;s why.
            As the hosting service, Netlify Analytics has advantages over client-side analytics. You
            can read about the types of information collected by Netlify and viewable by ballot.fyi{' '}
          ...
          <p>
            ...
            information from visitors) in any of the databases it owns. All email addresses are
            stored within Mailchimp. Some usage data is sent from Mailchimp to Google Analytics.
            <br />
            <br />
            ...
            of ballot.fyi at any point in the past, or if you subscribed to By The Bay, a similar
            and affiliated service to ballot.fyi in 2018. If you are a subscriber, you may
            unsubscribe immediately at any time.
            <br />
            <br />
            For more information:{' '}
